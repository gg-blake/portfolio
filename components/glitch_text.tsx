...
export default function GlitchTitle(props: {children: string}) {

    return (
        <span id={`${props.children.split(' ').join('-').toLowerCase()}`} className="relative  font-medium text-8xl  flex justify-start ">
